...
# 指令列表 - 描述从第0帧到第50帧的变化
INSTRUCTIONS = [
    "transfer the block from one hand to the other",
    "pass the block from left hand to right hand",
    "hand over the block between robotic arms",
    "move the block from one gripper to another",
    "exchange the block between hands",
    "handover the red block between manipulators"
]
